...
public class EntiteStade 
{
    ...
    String Equipelocale;
    String Position;
    EntiteVille StadeVille;

    public EntiteStade() {
    }

    public EntiteStade(String Nom, String Fondation, String Capacite, String Photo, String Equipelocale, String Position, EntiteVille StadeVille) {
        this.Nom = Nom;
    ...
    public EntiteVille getStadeVille() {
        return StadeVille;
    }
    ...
    public void setStadeVille(EntiteVille StadeVille) {
        this.StadeVille = StadeVille;
    }
