...
public class EntiteVille
{
    ...
    public EntiteVille(String Nom, String Fondation, String Population, String Photoville, String Equipelocale, String Logoville, String Logoequipe, String Coordonnees, String Timezone) {
        this.Nom = Nom;
