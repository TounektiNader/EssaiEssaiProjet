 ...
 * @author Ouss'Hr
 */
public class ShowVille3Controller implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) 
    {
        ...
        EntiteVille lsvilles = cs.FindVille("Kazan");
        ...
        List<EntiteCafe> lscafes = cs.FindCafeVille("Kazan");
        ...
        List<EntiteHotel> lshotels = cs.FindHotelVille("Kazan");
        ...
        List<EntiteResto> lsrestos = cs.FindRestoVille("Kazan");
