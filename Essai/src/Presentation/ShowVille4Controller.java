 ...
 * @author Ouss'Hr
 */
public class ShowVille4Controller implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) 
    {
        ...
        EntiteVille lsvilles = cs.FindVille("Moscou");
        ...
        List<EntiteCafe> lscafes = cs.FindCafeVille("Moscou");
        ...
        List<EntiteHotel> lshotels = cs.FindHotelVille("Moscou");
        ...
        List<EntiteResto> lsrestos = cs.FindRestoVille("Moscou");
