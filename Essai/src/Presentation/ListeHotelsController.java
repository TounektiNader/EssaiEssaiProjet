...
public class ListeHotelsController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) 
    {
       ...
       try 
        ...
        table_hotels.setOnMouseClicked((MouseEvent event) -> {
    ...
    {
        if (table_hotels.getSelectionModel().getSelectedItem() != null) 
        {
    ...
    private void Edit(ActionEvent event) throws SQLException, IOException 
    {
        ...
        n=rd.nextInt(10000)+1;
            ...
            alert.setTitle("Hotel modifié");
            alert.setHeaderText("Hotel modifié avec succès");
            alert.setContentText("Hotel "+nom1.getText()+" modifié avec succès");
            alert.showAndWait();
        }
        catch (Exception e)
                {
                Alert alert = new Alert(Alert.AlertType.ERROR);
                alert.setTitle("Hotel non modifié");
                alert.setHeaderText("Echec de la modification de l'hotel");
                alert.setContentText("Echec de la modification de l'hotel "+nom1.getText());
                alert.showAndWait();
                }
        Close(event);
        }
    ...
    public void insertionBase(String nomFile)throws URISyntaxException, MalformedURLException, IOException 
            {
                ...
                urlb.addParameter("nomhotel",nom1.getText());
