 ...
 * @author Ouss'Hr
 */
public class ShowVille10Controller implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) 
    {
        ...
        EntiteVille lsvilles = cs.FindVille("Sotchi");
        ...
        List<EntiteCafe> lscafes = cs.FindCafeVille("Sotchi");
        ...
        List<EntiteHotel> lshotels = cs.FindHotelVille("Sotchi");
        ...
        List<EntiteResto> lsrestos = cs.FindRestoVille("Sotchi");
