 ...
 * @author Ouss'Hr
 */
public class ShowVille11Controller implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) 
    {
        ...
        EntiteVille lsvilles = cs.FindVille("Volgograd");
        ...
        List<EntiteCafe> lscafes = cs.FindCafeVille("Volgograd");
        ...
        List<EntiteHotel> lshotels = cs.FindHotelVille("Volgograd");
        ...
        List<EntiteResto> lsrestos = cs.FindRestoVille("Volgograd");
