 ...
 * @author Ouss'Hr
 */
public class ShowVille6Controller implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) 
    {
        ...
        EntiteVille lsvilles = cs.FindVille("Rostov-sur-le-Don");
        ...
        List<EntiteCafe> lscafes = cs.FindCafeVille("Rostov-sur-le-Don");
        ...
        List<EntiteHotel> lshotels = cs.FindHotelVille("Rostov-sur-le-Don");
        ...
        List<EntiteResto> lsrestos = cs.FindRestoVille("Rostov-sur-le-Don");
