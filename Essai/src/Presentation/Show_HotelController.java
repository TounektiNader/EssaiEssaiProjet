 ...
 * @author Ouss'Hr
 */
public class Show_HotelController implements Initializable, MapComponentInitializedListener
{
    ...
    public static EntiteHotel caffe;
    ...
    public  void init(EntiteHotel caf)
    {
        caffe = new EntiteHotel();
    ...
    EntiteHotel v;
    void setVille(EntiteHotel object) throws SQLException 
    {
        ...
        List<EntiteHotel> lscafes = cs.FindHotelVille(object.getNom());
    ...
    EntiteHotel ville = new EntiteHotel();
