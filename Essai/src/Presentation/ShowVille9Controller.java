 ...
 * @author Ouss'Hr
 */
public class ShowVille9Controller implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) 
    {
        ...
        EntiteVille lsvilles = cs.FindVille("Saransk");
        ...
        List<EntiteCafe> lscafes = cs.FindCafeVille("Saransk");
        ...
        List<EntiteHotel> lshotels = cs.FindHotelVille("Saransk");
        ...
        List<EntiteResto> lsrestos = cs.FindRestoVille("Saransk");
