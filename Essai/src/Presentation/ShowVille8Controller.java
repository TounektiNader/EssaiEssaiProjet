 ...
 * @author Ouss'Hr
 */
public class ShowVille8Controller implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) 
    {
        ...
        EntiteVille lsvilles = cs.FindVille("Samara");
        ...
        List<EntiteCafe> lscafes = cs.FindCafeVille("Samara");
        ...
        List<EntiteHotel> lshotels = cs.FindHotelVille("Samara");
        ...
        List<EntiteResto> lsrestos = cs.FindRestoVille("Samara");
