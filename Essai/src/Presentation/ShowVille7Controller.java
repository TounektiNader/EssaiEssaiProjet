 ...
 * @author Ouss'Hr
 */
public class ShowVille7Controller implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) 
    {
        ...
        EntiteVille lsvilles = cs.FindVille("Saint-Pétersbourg");
        ...
        List<EntiteCafe> lscafes = cs.FindCafeVille("Saint-Pétersbourg");
        ...
        List<EntiteHotel> lshotels = cs.FindHotelVille("Saint-Pétersbourg");
        ...
        List<EntiteResto> lsrestos = cs.FindRestoVille("Saint-Pétersbourg");
