 ...
 * @author Ouss'Hr
 */
public class ShowVille2Controller implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) 
    {
        ...
        EntiteVille lsvilles = cs.FindVille("Kaliningrad");
        ...
        List<EntiteCafe> lscafes = cs.FindCafeVille("Kaliningrad");
        ...
        List<EntiteHotel> lshotels = cs.FindHotelVille("Kaliningrad");
        ...
        List<EntiteResto> lsrestos = cs.FindRestoVille("Kaliningrad");
