...
public class Password {
	...
	/**
	  ...
	  * just the same.
	  */
	public boolean verif(String passwd , String hash ) {
		String test_passwd = passwd;
		String test_hash = hash;
		...
		System.out.println("Verify against computed hash: " + compare_computed);
                if(compare_computed.equals("Passwords Match")&&compare_test.equals("Passwords Match"))
                {
                    return true;
                }
                else
